...
**Scope:** 1125 tickets analyzed | 2026-05-07 → 2026-08-05 <span style="color:red"><strong>**Remark: only tickets created by Non-Map Experts are considered here*</strong></span>

**Rejection Rate:** 0 disputed/flagged vs 853 total closed tickets in the last 90 days
...
- **MAPEX-8926** (Critical) — Source validation IM: ESP [79d overdue]
- **MAPEX-8995** (Critical) — Admin Area Maintenance 2026 Q3 – Source scouting and delivery for APA [47d overdue]
- **MAPEX-9291** (High) — Area & Postal language coverage [68d overdue]
- **MAPEX-9223** (High) — TTI - QC June-July 2026 - Global Events - APA [58d overdue]
- **MAPEX-9377** (High) — SO_TMC Source 2026 TUR HERE 7 [56d overdue]

**Assignee Overload (3+ flagged tickets):**

- Nikki Royce: 13 flagged tickets
...
1. 🔴 Immediately review and address 2 critical overdue ticket(s) — these are >90 days late or blocker priority.
